...
/*
  initDashboardPageCharts: function() {
    ...
    var optionsPreferences = { donut: true, donutWidth: 40, startAngle: 0, total: 100, showLabel: false, axisX: { showGrid: false } };
    Chartist.Pie("#chartPreferences", dataPreferences, optionsPreferences);
    Chartist.Pie("#chartPreferences", { labels: ["53%", "36%", "11%"], series: [53, 36, 11] });
    var dataSales = {
    ...
    var options = { seriesBarDistance: 10, axisX: { showGrid: false }, height: "245px" };
  ...
  */
  ...
  showNotification: function(from, align, msg,color) {
    ...
    //color = "red";
    //console.log(`color is  and x is ${x}`)
    // set number 1.normal blue 2.green 3.yellow 4.red
    $.notify(
      {
        icon: "nc-icon nc-app",
        message: `<span style='font-weight:bold;'>${msg}</span>`,
      },
      { type: type[color], timer: 8000, placement: { from: from, align: align } }
    );
  },
};
