        ...
        c(this, j),
          ...
          this.$element.on("switchChange.bootstrapSwitch", function() {
            ...
            !1 === l.options.onSwitchChange.apply(k, o) &&
              (l.$element.is(":radio") ? g('[name="' + l.$element.attr("name") + '"]').trigger("previousState.bootstrapSwitch", !0) : l.$element.trigger("previousState.bootstrapSwitch", !0));
          }),
          ...
          },
          {
            ...
            value: function(l) {
              return "undefined" == typeof l
                ...
                : (this.options.onColor && this.$on.removeClass(this._getClass(this.options.onColor)), this.$on.addClass(this._getClass(l)), (this.options.onColor = l), this.$element);
            },
          },
          {
            key: "offColor",
